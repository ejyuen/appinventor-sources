...
@SimpleObject
public final class TestWeb extends AndroidViewComponent {
    ...
    /**
     * Creates a new TestWeb component.
     *
     * @param container  container the component will be placed in
     */
    public TestWeb(ComponentContainer container) {
        super(container);
...
//            EclairUtil.setupWebViewGeoLoc(this, webview, container.$context());
     ...
     * Makes an html file
     */
    @SimpleFunction(description = "Testing making an HTML File.")
